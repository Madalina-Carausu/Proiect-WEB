                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if(data!=null&&data!=undefined){
                                document.getElementById("3rank1").innerHTML=data.name1+`<br>`+data.points1;
                                document.getElementById("3rank2").innerHTML=data.name2+`<br>`+data.points2;
                                document.getElementById("3rank3").innerHTML=data.name3+`<br>`+data.points3;
                            }
                            else
                            {
